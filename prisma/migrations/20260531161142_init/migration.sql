...
-- CreateIndex
CREATE UNIQUE INDEX "SlaRule_companyId_priority_key" ON "SlaRule"("companyId", "priority");
...
-- AddForeignKey
ALTER TABLE "SlaRule" ADD CONSTRAINT "SlaRule_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
